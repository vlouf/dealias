...
def debug_dealiasing(
    ...
    if strategy == "default":
        final_vel, flag_vel = dealiasing_process_2D(
            r, azimuth_reference, velocity_reference, elevation_reference, nyquist_velocity, alpha=alpha
        )
    else:
        final_vel, flag_vel = dealias_long_range(
            r, azimuth_reference, elevation_reference, velocity_reference, nyquist_velocity, alpha=alpha
        )
